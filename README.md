...
referred to as “nport” and the terminate port is referred to as “tport”
. Once the myftpserver
...
2. 3. You need to pay special attention to concurrency issues.
You can assume that the user uses the correct syntax when entering various commands
...
5. 6. 7. You may use C/C++/Java for your project.
If you are using Java, you are not allowed to use any thread-safe data structures.
All programs will be tested on Linux platform (nike). It is your responsibility to test and
make sure that your program works correctly on a Linux machine.
What to Submit:
A Zip folder containing:
1. 2. Your code for client and server.
A readme file containing (a) names of the students in the project group; (b) any special
